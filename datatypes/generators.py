...
# by the generator returned from large_dict.items(). It should be
# fairly lightweight, as compared to producing a list containing
# all the key-value pairs in the dictionary (see the Python 2 examples)
